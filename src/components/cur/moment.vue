<template>
  ...
  .a { top: 0; left: 5px; width: 20px; height: 5px; }
  .b { top: 5px; right: 0; width: 5px; height: 20px; }
  .c { bottom: 5px; right: 0; width: 5px; height: 20px; }
  .d { bottom: 0; left: 5px; width: 20px; height: 5px; }
  .e { bottom: 5px; left: 0; width: 5px; height: 20px; }
  .f { top: 5px; left: 0; width: 5px; height: 20px; }
  .g { top: 22.5px; left: 5px; width: 20px; height: 5px; }
