  <template>
    <div class="container">
      <div class="login-container">
        <div class="left-section" :class="{ moveRight: isSwitched }">
          <div v-if="!isSwitched"><img src="../../assets/thinking.png"></img></div>
          <div v-else>
            <div class="register-form">
              ...
              <form @submit.prevent="handleSubmit">
                ...
                <div class="form-group">
                  <div class="input-wrapper">
                    ...
                    <input type="text" v-model="code" placeholder="验证码" @blur="validateCode"
              ...
              <p class="signup-prompt">
                没有账户？ <a @click="gotoRegister" style="cursor: pointer;">立即注册！</a>
              </p>
            </div>
          </div>
        ...
        <div class="right-section" :class="{ MoveLeft: isSwitched }">
          <div v-if="!isSwitched">
          ...
          <div v-else>
            <img id='pic' src="../../assets/surfing.png"></img>
          </div>
